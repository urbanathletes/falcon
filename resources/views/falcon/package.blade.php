                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="package-box">
                                ...
                                <div class="package-body">
                                    <p>{{ $package->price }} / {{ $package->duration }}</p>
                                    <p>{{ $package->description }}</p>
                                    <p>{{ $package->additional_cost }}</p>
                                </div>
                                <div class="package-footer">
                                    <button type="button" class="btn btn-primary choose-package" data-package-id="{{ $package->id }}">Choose Package</button>
                                </div>
                            </div>
                        </div>
                        @endforeach
